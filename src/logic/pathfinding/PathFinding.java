...
public class PathFinding {
    ...
    public PathFinding(MapData mapData) {
        ...
        obstacleGrid = createGridOfObstacles(w, h, mapData.obstacles);
    ...
    public boolean[][] createGridOfObstacles(int width, int height, ObstacleData[] obstacles) {
        ...
        for (ObstacleData o : obstacles) {
            int x1 = (int) o.x - OFFSET_FROM_OBSTACLE;
            int x2 = (int) (o.x + o.width) + OFFSET_FROM_OBSTACLE;

            for (int x = x1; x < x2; x++) {
                int y1 = (int) o.y - OFFSET_FROM_OBSTACLE;
                int y2 = (int) (o.y + o.height) + OFFSET_FROM_OBSTACLE;
